...
select student.Id,student.name,student.sex,student.bithday,student.depart,student.phone,student.depart,student.email
from student,course,teacher,teaching,selecting
where selecting.s_Id = student.Id and selecting.c_Id = course.Id
  and teaching.c_Id = course.Id and teaching.t_Id = 1;
